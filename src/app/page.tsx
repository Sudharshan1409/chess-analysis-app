...
export default function AnalysisPage() {
  ...
  // Safe MultiPV lines slice (always 3 lines)
    ...
    <div className="min-h-screen lg:h-screen w-screen bg-[#21201d] text-gray-200 flex flex-col lg:flex-row font-sans select-none overflow-x-hidden lg:overflow-hidden">
      ...
      <div className="flex-1 h-full flex flex-col lg:flex-row p-2 lg:p-4 gap-4 items-center justify-center overflow-y-auto lg:overflow-hidden">
        ...
        <div className="flex-1 h-full max-h-[calc(100vh-2rem)] flex flex-col items-center justify-center min-w-0">
          ...
          <div className="w-[min(840px,90vw)] max-w-full flex items-center justify-between py-1 px-1 text-xs sm:text-sm text-gray-300 font-bold shrink-0">
            <div className="flex items-center gap-2">
          ...
          {settings.showEvalBar && (
            <div className="lg:hidden w-full max-w-[min(840px,90vw)] shrink-0">
              <HorizontalEvalBar
          ...
          {/* Expanded Desktop 1:1 Square Board Container (Width & Height up to 840px) */}
          <div className="h-[min(840px,calc(100vh-100px))] w-[min(840px,calc(100vh-100px))] max-h-[calc(100vh-100px)] max-w-full aspect-square flex items-center justify-center shrink-0 my-0">
          ...
          <div className="w-full max-w-[min(840px,90vw)] flex items-center justify-between py-1 px-1 text-xs sm:text-sm text-gray-300 font-bold shrink-0">
            <div className="flex items-center gap-2">
          ...
          <div className="lg:hidden w-full max-w-[min(840px,90vw)] bg-[#1e1c18] border-t border-[#312e2b] p-2 mt-2 rounded-lg shrink-0">
        ...
        <div className="w-full lg:w-[420px] h-full bg-[#262421] border border-[#312e2b] rounded-lg shadow-2xl flex flex-col shrink-0 overflow-hidden">
          ...
          {/* Fixed-Height MultiPV Engine Lines Box */}
